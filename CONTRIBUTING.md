# 🤝 Contributing to See-Sense

**See-Sense** investigates the accuracy of **AI-driven carbohydrate estimation**
to support **Type 1 Diabetes (T1D)** management.
...
By building a **Gold Standard dataset** and optimizing models for
**consumer-grade hardware** (e.g., RTX 3050), this project aims to reduce
the **mental burden of carb counting** for the T1D community.
